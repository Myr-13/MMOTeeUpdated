...
public:
	...
	virtual void ResetBotInfo(int ClientID, int BotType, int BotSubType, int WorldID) = 0;
	virtual void InitClientBot(int ClientID, int WorldID) = 0;
