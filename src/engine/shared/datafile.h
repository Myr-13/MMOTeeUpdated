...
public:
	...
	bool Open(class IStorage2 *pStorage, const char *pFilename, int StorageType);
	bool Close();

	static bool GetCrcSize(class IStorage2 *pStorage, const char *pFilename, int StorageType, unsigned *pCrc, unsigned *pSize);
...
public:
	CDataFileWriter();
	~CDataFileWriter();
	bool Open(class IStorage2 *pStorage, const char *Filename);
