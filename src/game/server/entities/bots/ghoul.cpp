...
CGhoul::CGhoul(CGameWorld *pWorld)
: CCharacter(pWorld)
{
	m_BotDir = 1;
	m_BotLastPos = m_Pos;
...
bool CGhoul::TakeDamage(vec2 Force, int Dmg, int From, int Weapon)
{
...
void CGhoul::PlaySound()
{

}

void CGhoul::RunAction()
{
...
void CGhoul::TickBotAI()
{
	...
	for (int i=0; i<g_Config.m_SvMaxClients; i++)
	{
	    ...
	    if (!pPlayer || !pPlayer->GetCharacter() || pPlayer->IsBot() || (pPlayer->GetBotType() == BOT_L1MONSTER || pPlayer->GetBotType() == BOT_L4MONSTER))
            continue;
